            ...
            <NavLink to="/messages" className={navItemClass}>
              <div className="relative inline-flex items-center">
                ...
                {unreadMessageCount > 0 && (
                  <span className="absolute -top-1 -right-3 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-semibold leading-none text-white bg-teal-600 rounded-full">
          ...
          <div className="px-4 pt-2 pb-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 animate-in slide-in-from-top-2 duration-200">
            <nav className="flex flex-col space-y-2">
              ...
              >
                ...
                <span>Mensajes</span>
                {unreadMessageCount > 0 && (
                  <span className="ml-auto px-2 py-0.5 text-xs font-semibold text-white bg-teal-600 rounded-full">
                    {unreadMessageCount > 99 ? '99+' : unreadMessageCount}
                  </span>
                )}
              </NavLink>
